...
## 3. Building Docker Images {#section-3}
...
$ docker inspect --format '{{.State.Pid}}' hello   // gives out processes id of hello
...
## 5. Orchestration: Building Systems with Docker {#section-5}
